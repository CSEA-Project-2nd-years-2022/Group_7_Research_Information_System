...
function BookChapter() {
  ...
  const getJournals = () => {
    Axios.get("http://localhost:3001/ShowBookChapter").then((response) => {
              ...
              >
                <table style={tableElements}>
                  <tr>
                    ...
                    <th style={tableElements}>Title Book Chapter</th>
                    <th style={tableElements}>Title of Book</th>
                    <th style={tableElements}>ISBN</th>
                    <th style={tableElements}>Co Author</th>
                    <th style={tableElements}>Year of Publication</th>
                    <th style={tableElements}>Publisher Name</th>
                  </tr>
                  {bookList
                    .filter((val) => {
                      if (searchItem === "") {
