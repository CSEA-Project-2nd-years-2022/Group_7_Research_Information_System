...
function AddTechTransfer() {
  ...
  const [num_people_involved, setNum_people_involved] = useState(0);

  const [techtransferList, settechtransferList] = useState([]);

  const displayInfo = () => {
    console.log(emp_id + num_tech_tran + title_tech_tran + industry_alliance + num_people_involved);
  };
                    ...
                    <div>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onChange={(event) => {
                            setNum_People_Involved(event.target.value);
                          }}
