...
function Consultancy() {
  ...
  const getJournals = () => {
    Axios.get("http://localhost:3001/ShowConsultancy").then((response) => {
        ...
        <div className="columnRight">
          <div>
            ...
            >
              ...
              <br />
              <br />
              <h2 style={{ opacity: "100%", fontSize: "30px" }}>CONSULTANCY</h2>
              <form>
                <div>
                  <input
              ...
              >
                <table style={tableElements}>
                  <tr>
                    ...
                    <th style={tableElements}>Consultant Department</th>
                    <th style={tableElements}>Consultancy Name</th>
                    <th style={tableElements}>Consulting Agency</th>
                    <th style={tableElements}>revenue_generated</th>
                    <th style={tableElements}>grant_released</th>
                    ...
                    .map((val) => {
                      return (
                        <tr>
                          ...
                          <td style={tableElements}>{val.name_consultant_departement}</td>
                          <td style={tableElements}>{val.name_consultancy}</td>
                          <td style={tableElements}>{val.consulting_agency}</td>
                          <td style={tableElements}>{val.revenue_generated}</td>
