...
function SponsoredResearchProjects() {
  const [researchProjectList, setJournalList] = useState([]);
  const getJournals = () => {
    Axios.get("http://localhost:3001/ShowResearchProjects").then((response) => {
        ...
        <div className="columnRight">
          <div>
            ...
            >
              ...
              <br />
              <br />
              <h2 style={{ opacity: "100%", fontSize: "30px" }}>SPONSORED RESEARCH PROJECTS</h2>
              <form>
                <div>
                  <input
              ...
              >
                <table style={tableElements}>
                  <tr>
                    ...
                    <th style={tableElements}>Project Name</th>
                    <th style={tableElements}>Funding Agency</th>
                    <th style={tableElements}>Total Grant Sanctioned</th>
                    <th style={tableElements}>Principal Investigator</th>
                    <th style={tableElements}>Co-principal investigator</th>
                    <th style={tableElements}>Duration</th>
                    <th style={tableElements}>Grant Released</th>
                    <th style={tableElements}>Status</th>
                  </tr>
                  {researchProjectList
                    .filter((val) => {
                      if (searchItem === "") {
                    ...
                    .map((val) => {
                      return (
                        <tr>
                          ...
                          <td style={tableElements}>{val.project_name}</td>
                          <td style={tableElements}>{val.funding_agency}</td>
                          <td style={tableElements}>{val.total_grant_sanctioned}</td>
                          <td style={tableElements}>{val.principal_investigator}</td>
                          <td style={tableElements}>{val.coprincipal_investigator}</td>
                          <td style={tableElements}>{val.duration}</td>
                          <td style={tableElements}>{val.grant_released}</td>
                          <td style={tableElements}>{val.status}</td>
                        </tr>
                      );
                    })}
                </table>
...
export default SponsoredResearchProjects;
